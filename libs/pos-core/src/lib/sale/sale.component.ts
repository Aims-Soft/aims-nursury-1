          ...
          for (const packageProduct of packageProdList) {
            ...
            if (existingProductIndex !== -1) {
              ...
              this.productSaleTable.tableData.push({
                ...
                categoryName: packageProduct.categoryName,
                sizeName: packageProduct.sizeName,
                qty: 1,
    ...
    for (var i = 0; i < this.productSaleTable.tableData.length; i++) {
      if (this.productSaleTable.tableData[i].status != 'deleted') {
        prodTableData.push({
          ...
          categoryName: this.productSaleTable.tableData[i].categoryName,
          sizeName: this.productSaleTable.tableData[i].sizeName,
